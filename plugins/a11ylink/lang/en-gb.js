...
*
* The 'a11ylink' plugin was based originally on the CKSource 'link' plugin:
*
* @license Copyright (c) 2003-2019, CKSource - Frederico Knabben. All rights reserved.
* For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-oss-license
*/

CKEDITOR.plugins.setLang( 'a11ylink', 'en-gb', {
  ...
  a11yFirstInvalidDisplayText: ['add', 'click', 'click here', 'clone',
    'delete', 'download', 'go to', 'here', 'image', 'link to', 'link',
    'more', 'order', 'read', 'read more', 'view', 'clic aqu&iacute;',
    'clic', 'haga clic', 'm&aacute;s', 'aqu&iacute;'],
